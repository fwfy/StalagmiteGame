...
gameContext.debugging = true;
gameContext.run = true;
gameContext.audioContext = null;
gameContext.gainNode = null;
gameContext.accumulator = 0;
gameContext.previousTime = performance.now();
gameContext.queuedSounds = [];
gameContext.soundsPlaying = [];
gameContext.started = false;
gameContext.bgImg = new Image();
gameContext.dogs = [new Image(), new Image()];
gameContext.dogs[0].src = "assets/other/dog1.png";
gameContext.dogs[1].src = "assets/other/dog2.png";
gameContext.keysPressed = new Set();
gameContext.ents = [];
gameContext.soundsLoaded = false;
...
gameContext.dbgFlags = {
	disableSpiralPrevention: false
}
gameContext.activeMenu;
gameContext.activeLevel;
gameContext.activeCutscene;
gameContext.player;
gameContext.inputs = [];
gameContext.recording = false;
gameContext.playingDemo = false;

gameContext.LEVEL_SEQUENCE = [
	"test2",
	"test2"
];

gameContext.curr_level = 0;
...
gameContext.MENUS = {
	...
	SECRET_MENU_LAYOUT: {
		"title": "ALL MENUS",
		"init": _ => {
			for (const menu of gameContext.MENUS) {
